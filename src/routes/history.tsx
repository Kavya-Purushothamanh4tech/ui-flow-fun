            ...
            >
              <div className="relative h-32">
                ...
                <div className="absolute bottom-3 left-3 right-3 flex items-end justify-between text-white">
                  ...
                  <span className="text-sm font-bold bg-success/90 px-2 py-1 rounded-lg">
                    +${v.reward}
                  </span>
                </div>
              </div>
...
function EmptyState() {
  return (
    <div className="text-center py-16">
      <div className="size-20 mx-auto rounded-3xl bg-accent flex items-center justify-center text-3xl">
        📋
      </div>
