    ...
    <PhoneShell>
      ...
      <div className="px-6 space-y-5">
          ...
          <div className="grid grid-cols-2 gap-3 p-1">
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Input
                  className="h-11 pl-9 rounded-xl bg-background uppercase"
                  defaultValue="NY ABC-4521"
                />
              </div>
            </div>
            <div className="space-y-1.5">
        ...
        <Block label="Location">
          <div className="flex items-center gap-3 p-1">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-semibold truncate">5th Avenue & E 42nd Street</p>
              <p className="text-[11px] text-muted-foreground">
                New York, NY 10017 · 40.7527°N, 73.9772°W
              </p>
            </div>
            <span className="text-[10px] font-bold text-success bg-success/15 px-2 py-1 rounded-full">
              GPS
            </span>
          </div>
        </Block>
        ...
        <Button
          asChild
          size="lg"
          className="w-full h-12 rounded-2xl bg-gradient-primary shadow-elevated text-base font-semibold mt-2"
        >
          <Link to="/history">
            <Check /> Submit report
          </Link>
...
function Block({ label, children }: { label: string; children: React.ReactNode }) {
  return (
    <div>
      ...
      <div className="mt-2 p-3 rounded-2xl bg-card border border-border shadow-card">
        {children}
      </div>
    </div>
  );
